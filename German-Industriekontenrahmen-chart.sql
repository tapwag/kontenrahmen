-- Industriekontenrahmen für deutsche Berufsschulen -> Chart of Accounts for German education purposes
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('0200','Konzessionen, gew. Schutzrechte und ähnliche Rechte','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('0300','Geschäfts- oder Firmenwert','A','A0','A','');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('0530','Betriebsgebäude','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('0540','Verwaltungsgebäude','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('0720','Anlagen und Maschinen','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('0750','Transportanlagen und ähnliche Betriebsvorrichtungen','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('0790','Sammelposten Anlagen und Maschinen (150,01 € - 1.000,00 €)','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('0791','Sammelposten Anlagen und Maschinen Jahr 1','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('0792','Sammelposten Anlagen und Maschinen Jahr 2','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('0900','Geleistete Anzahlungen und Anlagen im Bau','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('0950','Anlagen im Bau','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1300','Beteiligungen','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1500','Wertpapiere des Anlagevermögens','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2000','Rohstoffe','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2001','Bezugskosten f. Rohstoffe','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2000','Nachlässe für Rohstoffe','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2010','Vorprodukte/Fremdbauteile','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2011','Bezugskosten für Vorprodukte und Fremdbauteile','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2012','Nachlässe für Vorprodukte und Fremdbauteile','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2020','Hilfsstoffe','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2021','Bezugskosten für Hilfsstoffe','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2022','Nachlässe für Hilfsstoffe','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2070','Sonstiges Material','A','A0','A','');

insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2100','Unfertige Erzegnisse','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2200','Fertige Erzeugnisse','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2280','Waren (Handelswaren)','A','A0','A','');

insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2300','Geleistete Anzahlungen','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2400','Forderungen aus Lieferungen und Leistungen','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2450','Wechselforderungen','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2470','Zweifelhafte Forderungen','A','A0','A','');

insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2600','Vorsteuer','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2630','Sonstige Forderungen an Finanzbehörden','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2640','SV-Beitragsvorauszahlungen','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2650','Forderungen an Mitarbeiter','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2690','Übrige sonstige Forderungen','A','A0','A','');

insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2800','Guthaben bei Kreditinstituten (Bank)','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2850','Postbankguthaben','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2880','Kasse','A','A0','A','');

insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2900','Aktive Rechnungsabgrenzung','A','A0','A','');

insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3000','Eigenkapital','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3001','Privatkonto','A','A0','A','');

insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3610','Wertberichtigungen zu Sachanlagen','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3650','Wertberichtigungen zu Finanzanlagen','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3660','Einzelwertberichtigungen zu Forderungen','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3670','Pauschalwertberichtigungen zu Forderungen','A','A0','A','');

insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3700','Rückstellungen zu Pensionen und ähnliche Verpflichtigungen','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3800','Steuerrückstellungen','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3900','Sonstige Rückstellungen','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3910','Sonstige Rückstellungen für Gewährleistung','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3930','Sonstige Rückstellungen für ungewisse Verbindlichkeiten','A','A0','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3970','Sonstige Rückstellungen für drohende Verluste aus schwebenden Geschäften','A','A0','A','');
